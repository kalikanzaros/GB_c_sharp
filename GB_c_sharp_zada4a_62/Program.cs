...
в принципе исходя из условий задачи можно сформировать два массива, один с значениями по порядку второй со значениями индекса
и итерацией назначить значения второму по индексам, хотя тогда и два массива не нужно
однакож, это жжжжж неспроста
можно задать размерность))))
 */
